        ...
        (u.charset = "utf-8"),
          ...
          (u.src = (function (e) {
            return (
              o.p +
              "" +
              ({ 1: "vendors~rollbar.noconflict.umd.min" }[e] || e) +
              ".js"
            );
          })(e));
        var c = new Error();
  ...
  function (e, t, n) {
    ...
    var m = function e() {
        ...
        v(this, e),
          ...
          (this.isUserError = r),
          (this.rollbarFingerprint = this.message);
      },
      b = {},
      w = {},
      g = {};
              ...
              return new h(function (t, n) {
                "loading" !== e.doc.readyState && e.doc.body
                  ...
                  : e.doc.addEventListener("DOMContentLoaded", function () {
                      e.doc.body
                        ? t()
                        : n(new m("host page document.body not available"));
                    });
              });
            },
          },
            ...
            },
            {
              ...
              value: function (e, t) {
                ...
                return this.productIframe
                  ...
                  .catch(function () {
                    return h.reject(n.loadProductError());
                  });
              },
            },
            {
        ...
        (n = [
            ...
            value: function () {
              ...
              return (
                this.version &&
                  ((e =
                    this.baseUrl +
                    "?".concat(this.getSerializedVersionQueryParam())),
                  this.displayWarning()),
                decodeURI(e)
              );
            },
          ...
          },
          {
            ...
            value: function (e) {
              ...
              if (t) {
                var n = t.split("/");
                if (this.validSha(n[1])) return { name: n[0], sha: n[1] };
              }
            },
          },
          {
        ...
        (n = [
          {
            ...
            value: function (e) {
              ...
              return new h(function (r, o) {
                ...
                n
                  ? ((i.zEACLoaded = !0),
                    i.$zopim ? r(w.products) : r(b.products))
                  : y(new T(i, e).resolveComposeUrl())
                      .then(function (e) {
                        var t = e.products;
                        (i.zEACLoaded = !0), r(t);
                      })
          ...
          },
          {
            key: "error",
            value: function (e) {
              return new m("compose request failed", { key: e });
            },
          },
        ]) && C(t.prototype, n),
        r && C(t, r),
        ...
        (r = [
          {
            ...
            value: function () {
              ...
              return new h(function (t, n) {
                ...
                return r
                  ? e._isHostMapped(r)
                    ? y("https://".concat(r, "/embeddable/zendesk_host"))
                        .then(function (e) {
    ...
    var D = (function (e) {
      function t() {
        return B(this, t), H(this, Z(t).apply(this, arguments));
      }
      var n, r, o;
      return (
        (function (e, t) {
    ...
    var te = null,
      ne = {
        ...
        transform: function (e) {
          var t = (((e.body || {}).message || {}).extra || {})
            .rollbarFingerprint;
          t &&
            ((e.fingerprint = t),
            (e.title = "AssetComposerError: ".concat(
              e.body.message.extra.message
            )));
        },
    ...
    !(function () {
      try {
        ...
        t.getKey()
          ...
          .then(function (e) {
            return h.all(n.loadProducts(n.getProductLoaders(e), !1));
          })
          .catch(function (e) {
            return oe(e);
          });
